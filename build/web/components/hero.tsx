...
import { getSiteInfo, getCTA } from "@/lib/metadata";
  ...
  return (
    <div className="relative z-10">
      ...
      <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
        <a
          href={cta.link}
          className="w-40 rounded-lg px-4 py-2 text-sm text-center bg-white text-black border border-neutral-200 shadow hover:bg-neutral-100 transition-colors"
        >
          {cta.label}
        </a>
      </div>
